...
public class UniStormSunShaftsPass : ScriptableRenderPass
{
    ...
    public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
    {
        ...
        // Allocate RTHandle instead of using GetTemporaryRT
        destination = RTHandles.Alloc(cameraTextureDescriptor);
    ...
    cmd.Blit(source, destination, sunShaftsMaterial, (settings.screenBlendMode == UniStormSunShaftsFeature.ShaftsScreenBlendMode.Screen) ? 0 : 4);
