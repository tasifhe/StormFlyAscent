...
{
    /// <summary>A <see cref="CharacterState"/> which keeps the character standing still.</summary>
    ...
    public sealed class IdleState : CharacterState
    {
        ...
        /// <summary>
        /// Constantly clears the <see cref="Rigidbody.velocity"/> to ensure that the character doesn't slide or get
